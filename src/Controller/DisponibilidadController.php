...
class DisponibilidadController extends AbstractController
{
    ...
    //     ]);
    // }
    #[Route('/{idEvento}', name: 'app_disponibilidad_index', methods: ['GET'])]
    public function getButacas(DisponibilidadRepository $disponibilidadRepository, $idEvento): Response
    {
        $butacas=[];
        try{
