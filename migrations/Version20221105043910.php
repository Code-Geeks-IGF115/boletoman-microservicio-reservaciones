 ...
 */
final class Version20221105043910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE disponibilidad_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE sala_de_eventos_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE butaca (id INT NOT NULL, celda_id INT NOT NULL, codigo_butaca VARCHAR(15) NOT NULL, disponible VARCHAR(10) NOT NULL, mesa INT DEFAULT NULL, detalle_compra_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE celda (id INT NOT NULL, categoria_butaca_id INT DEFAULT NULL, sala_de_eventos_id INT NOT NULL, fila INT NOT NULL, columna INT NOT NULL, cantidad_mesas INT NOT NULL, cantidad_butacas INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE disponibilidad (id INT NOT NULL, butaca_id INT NOT NULL, disponible VARCHAR(100) NOT NULL, id_evento INT DEFAULT NULL, id_detalle_compra INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_4B6AAB2F6FAB8B66 ON disponibilidad (butaca_id)');
        ...
        $this->addSql('ALTER TABLE disponibilidad ADD CONSTRAINT FK_4B6AAB2F6FAB8B66 FOREIGN KEY (butaca_id) REFERENCES butaca (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE disponibilidad_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE disponibilidad DROP CONSTRAINT FK_4B6AAB2F6FAB8B66');
